...
public class AudioRecoderUtilsCopy {

    private static AudioRecoderUtilsCopy instance = new AudioRecoderUtilsCopy();

    public static AudioRecoderUtilsCopy getInstance() {
        return instance;
    }
    ...
    public AudioRecoderUtilsCopy(String filePath) {
     ...
     * @return
     */
    public void startRecord(String number ,String name) {
        ...
        try {
            ...
            // 0 是未播放 ，1 是播放
            filePath = FolderPath + "0_"+getTime()+"_"+number+"_"+name+".amr";
            /* ③准备 */
