...
public class VoiceRecodingAdapter extends BaseAdapter {
    private String TAG = "VoiceRecodingAdapter";
    private Context mContext;
    private ArrayList<ItemBean> list;
    private int defaultSelection = 0;

    public VoiceRecodingAdapter(Context mContext, ArrayList<ItemBean> list){
