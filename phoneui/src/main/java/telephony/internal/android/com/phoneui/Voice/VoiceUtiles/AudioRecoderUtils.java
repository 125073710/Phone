...
public class AudioRecoderUtils {
    ...
    private static AudioRecoderUtils instance = new AudioRecoderUtils();
     ...
     * @return
     */
    public void startRecord(Context mContext,String number , String name, String typ) {
        ...
        try {
            ...
            Log.e(TAG,"filePaht="+filePath);
            VoiceDBoperations.getInstance().insert(mContext,filePath,number,name,typ);
            /* ③准备 */
     ...
     * 文件名 确保唯一性
     * @return
     * 20180101020202000_1826873.arm
     */
    public String getfileName(){
        return getTime()+getRandom()+"_"+number+".amr";
    }
